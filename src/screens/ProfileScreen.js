...
const items =[
	...
	{title:'Unsuccessful Dribbles',key:'unsuccessfulDribbles',color:badOffence},
...
const gkItems=[
	...
	{title:'Penalty Goals Allowed', key:'penaltyGoalsAllowed', color:badOffence},	
							...
							<ListItem
								...
								rightIcon={
									<View style={{backgroundColor:item.color,borderRadius:100, padding:10, height:50, width:50, justifyContent:'center'}}>
										<Text h4  style={{alignSelf:'center'}} h4Style={{fontSize:14, color:'#fff'}}>{per90(item.key)}</Text>
									</View>
								}
							/>
						)
